    ...
    with open("package.json") as packege:
        ...
        for new_organization in data['organizations']:
            if new_organization['name'] not in existing_orgs_names:
                ...
                new_org.save()
                if 'personel' in new_organization:
                ...
                if 'personel' in new_organization:
                    ...
                    for person in new_organization['personel']:
                        ...
                        print('Users: ', User.objects.filter(username=''.join([person['name'], person['surname'], person['middlename']])))
                        if User.objects.filter(username=''.join([person['name'], person['surname'], person['middlename']])):
                            print('ALL ok')
                            # deleting old user
                            ...
                            Admin = User.objects.create_superuser(username='blake', password='eehung4wa', email='blakexxxd@gmail.com')
